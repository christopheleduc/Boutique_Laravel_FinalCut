...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 25 juil. 2019 à 14:51
...
INSERT INTO `contacts` (`id`, `firstName`, `lastName`, `image`, `linkedin`, `description`, `updated_at`, `created_at`) VALUES
(1, 'Christophe', 'Leduc', 'christophe_vignette.png', 'https://www.linkedin.com/in/christophe-leduc-81a19b82/', '', '2019-03-26 11:23:44', '2019-03-21 13:35:49'),
(2, 'Eric', 'DelGuerra', 'eric_vignette.png', 'https://www.linkedin.com/in/eric-del-guerra-66245480/', '', '2019-03-26 11:23:44', '2019-03-21 13:35:49'),
(3, 'Cédric', 'Alonso', 'cedric_vignette.png', 'https://www.linkedin.com/in/c%C3%A9dric-alonso-649074155/', '', '2019-03-26 11:23:44', '2019-03-21 13:35:49'),
(4, 'Melanie', 'Brustlein', 'melanie_vignette.png', 'https://www.linkedin.com/in/melanie-brustlein-459934180/', '', '2019-03-26 11:23:44', '2019-03-21 13:35:49');
...
(2, 'L\'encyclopédie des petits dauphins moches.', 'Découvrez le véritable visage de la mer, celui des Bélugas.', 'beluga.jpg', 120, 1000, 49, 1, 0, '2019-03-21 23:00:00', '2019-03-22 09:44:09'),
...
(18, '\"Les poignées de porte dans leurs états naturels.\"', 'Véritable consécration pour Bernard Don Moricio avec ce portfolio qui à fait l\'unanimité au \"conseil des photos qu\'elles sont belles\".', 'poignet.jpg', 2500, 300, 20, 1, 0, '2019-03-21 13:36:12', '2019-03-21 13:36:12'),
